...
import { becomeProvider, login, register } from '@/routes';
import business from '@/routes/business';
import client from '@/routes/client';
import { type BreadcrumbItem, type SharedData } from '@/types';
import { Link, usePage } from '@inertiajs/react';
import { CalendarSync, Heart, Menu, Store, Wallet } from 'lucide-react';
...
const activeItemStyles =
    'text-foreground after:absolute after:-bottom-1.5 after:left-0 after:h-0.5 after:w-full after:translate-y-px after:bg-emerald-950';
                                        ...
                                        {auth?.user && (
                                            <>
                                                ...
                                                <button
                                                    ...
                                                    className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left font-medium hover:bg-muted"
                                                >
                                        ...
                                        <Link
                                            ...
                                            className={cn(
                                                ...
                                                isNavItemActive(item.href) &&
                                                    activeItemStyles,
                                                'relative h-9 cursor-pointer bg-transparent px-3 text-gray-700 shadow-none hover:bg-transparent hover:text-foreground focus:bg-transparent data-[active=true]:bg-transparent data-[state=open]:bg-transparent dark:text-gray-200',
                                            )}
                                            prefetch
                                        >
                                            {item.title}
                            ...
                            <>
                                ...
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button
                                            variant="ghost"
                                            className="size-8 rounded-full p-0.5 sm:size-10 sm:p-1"
                                        >
