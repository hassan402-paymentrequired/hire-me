    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          primary: "border-transparent bg-green-600 text-white [a&]:hover:bg-green-600/90 focus-visible:ring-green-600/20 dark:focus-visible:ring-green-600/40 dark:bg-green-600/60 "
      },
    },
    defaultVariants: {
      variant: "default",
